    ...
    <div class="container">
        ...
        <form @submit.prevent="AddArticle" class="mb-3">
            <div class="form-group">
                <!-- v-model serve para lincar os dados (q estao no data) -->
                <input type="text" class="form-control" placeholder="Title" v-model="article.title">
            </div>

            <div class="form-group">
                <textarea class="form-control" placeholder="Body" v-model="article.body" cols="30" rows="5"></textarea> 
            </div>
...
<nav aria-label="Navegação de página exemplo">
  <ul class="pagination">
    ...
    <li v-bind:class="[{disabled: !pagination.next_page_url}]" class="page-item">
        ...
        <button @click="deleteArticle(article.id)" class="btn btn-dark">Delete</button>
    </div>
